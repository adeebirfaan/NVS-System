...
<div class="container page-container">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <h2 class="page-title mb-0">Manage Agencies</h2>

        <a href="{{ route('mcmc.agencies.create') }}" class="btn btn-gradient btn-modern">
        ...
        <div class="card-body">
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-4 d-flex gap-2 flex-wrap">
                    ...
                    <a href="{{ route('mcmc.agencies.index') }}" class="btn btn-glass btn-modern">Clear</a>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <table class="table glass-table table-hover align-middle">
                        ...
                        <tbody>
                            @forelse($agencies as $agency)
                                <tr>
                                    <td>
                                        <span class="muted-text">{{ $agency->id }}</span>
                                    </td>

                                    <td>
                                        <span class="glass-badge badge-code">
                                            {{ $agency->code }}
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 flex-wrap">
                                            <a href="{{ route('mcmc.agencies.show', $agency) }}" class="btn btn-sm action-btn" title="View">
                                                <i class="bi bi-eye"></i>
                                            </a>

                                            <a href="{{ route('mcmc.agencies.edit', $agency) }}" class="btn btn-sm action-btn-warning" title="Edit">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center empty-text">No agencies found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
