    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('mcmc.users.store') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('role') is-invalid @enderror" id="role" name="role" required>
                                ...
                                <option value="mcmc" {{ old('role') == 'mcmc' ? 'selected' : '' }}>MCMC Staff</option>
                                <option value="agency" {{ old('role') == 'agency' ? 'selected' : '' }}>Agency Staff</option>
                            </select>
                            @error('role')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
